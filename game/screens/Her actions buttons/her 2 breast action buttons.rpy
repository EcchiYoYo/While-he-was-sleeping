    ...
    imagebutton:
        ...
        if activate_buttons == True:
            if pc.stamina >= 5:
                ...
                hovered Show("her_tooltip", input_text = f"Rub your left breast increasing your arousal level by {{color=#FFB0F2}}{increase_arousal}", x_pos = 0.15, y_pos = 0.13)
                ...
                hovered Show("her_tooltip", input_text = "Not enough stamina for this action, requires 5 you have [pc.stamina], consider ending the night ({color=#E32636}Make sure you hide any evidence left on his body)", x_pos = 0.15, y_pos = 0.13)
                action NullAction()
        else:
            idle "images/buttons/left breast button.png"
            hover "images/buttons/left breast button hover.png"
    ...
    imagebutton:
        ...
        if activate_buttons == True:
            if pc.stamina >= 5:
                ...
                hovered Show("her_tooltip", input_text = f"Rub your right breast increasing your arousal level by {{color=#FFB0F2}}{increase_arousal}", x_pos = 0.15, y_pos = 0.23)
    ...
    imagebutton:
        ...
        if activate_buttons == True:
            if pc.stamina >= 7:
                ...
                hovered Show("her_tooltip", input_text = f"Rub both of your breasts increasing your arousal level by {{color=#FFB0F2}}{increase_arousal}", x_pos = 0.15, y_pos = 0.33)
    ...
    imagebutton:
        ...
        if activate_buttons == True:
            if pc.stamina >= 5:
                ...
                hovered Show("her_tooltip", input_text = f"Pinch your left nipple increasing your arousal level by {{color=#FFB0F2}}{increase_arousal}", x_pos = 0.15, y_pos = 0.43)
    ...
    imagebutton:
        ...
        if activate_buttons == True:
            if pc.stamina >= 5:
                ...
                hovered Show("her_tooltip", input_text = f"Pinch your right nipple increasing your arousal level by {{color=#FFB0F2}}{increase_arousal}", x_pos = 0.15, y_pos = 0.53)
    ...
    imagebutton:
        ...
        if activate_buttons == True:
            if pc.stamina >= 7:
                ...
                hovered Show("her_tooltip", input_text = f"Pinch both of your nipples increasing your arousal level by {{color=#FFB0F2}}{increase_arousal}",x_pos = 0.15, y_pos = 0.63)
