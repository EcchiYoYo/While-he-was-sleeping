label you_work_a_little:
    if persistent.first_upgrade_visit == False: # used to check if the scene tricking Grace has been seen before
        ...
        pc_talk "So?"
        gabrielle "Well if we trick her into thinking she`s performing these upgrades on you but instead she performs them on [first_use] he won`t wake so easily and you can have more time using him for pleasure."
        ...
        gabrielle "Well cum is easiest but even sweat will do, so any item of clothing he has worn should be enough."
        #
        #
        # Player retrieves the item images
        #
        ...
        gabrielle "Okay I will get this done while you`re at work, once you get back come and see me and we`ll get started with [grace.name]`s ritual, you also earned a few coins last night so make sure you buy an upgrade or two."
        pc_talk "Yeah you`re right I don`t wanna be late, catch you later [gabrielle.name]."
        "With that you head off to work."
    python:
        globalAdvanceTime(1) # located in global stuff
        cash_earned = globalPoundsEarnedWorking() # located in global stuff
